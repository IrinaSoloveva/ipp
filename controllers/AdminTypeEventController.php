...
use app\models\filters\TypeEventFilter;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AdminTypeEventController implements the CRUD actions for TypeEvent model.
 */
class AdminTypeEventController extends Controller
{
    ...
    {
        $searchModel = new TypeEventFilter();
    ...
    {
        if (($model = TypeEvent::findOne(['id' => $id])) !== null) {
            return $model;
        }
